...
CREATE TABLE users (
    ...
    pno_number VARCHAR(50) UNIQUE NOT NULL,
    ...
    role VARCHAR(50) NOT NULL CHECK (role IN ('COMPUTER_OPERATOR', 'DISTRICT_SP', 'SP_COMPUTER_CENTRE', 'IG_TECHNICAL_SERVICES', 'HQ_REVIEWER', 'ADG_TECHNICAL_SERVICES', 'ADMIN', 'SUPERVISOR', 'DIG', 'IG', 'HQ', 'SUPER_ADMIN')),
...
CREATE TABLE transfer_requests (
    ...
    current_stage VARCHAR(30) DEFAULT 'DRAFT' CHECK (current_stage IN ('DRAFT', 'ADMIN_VERIFICATION', 'DISTRICT_SP_APPROVAL', 'SP_UPPCC_APPROVAL', 'IG_TS_APPROVAL', 'HQ_REVIEW', 'FINAL_APPROVAL', 'APPROVED', 'REJECTED')),
...
CREATE TABLE approval_history (
    ...
    from_stage VARCHAR(30) NOT NULL CHECK (from_stage IN ('DRAFT', 'ADMIN_VERIFICATION', 'DISTRICT_SP_APPROVAL', 'SP_UPPCC_APPROVAL', 'IG_TS_APPROVAL', 'HQ_REVIEW', 'FINAL_APPROVAL', 'APPROVED', 'REJECTED')),
    to_stage VARCHAR(30) NOT NULL CHECK (to_stage IN ('DRAFT', 'ADMIN_VERIFICATION', 'DISTRICT_SP_APPROVAL', 'SP_UPPCC_APPROVAL', 'IG_TS_APPROVAL', 'HQ_REVIEW', 'FINAL_APPROVAL', 'APPROVED', 'REJECTED')),
    remarks TEXT NULL,
